...
export default function TutorialPanel({ onBack }: TutorialPanelProps) {
  return (
    <section className="tutorial-panel" aria-label="How to Play">
      <header className="tutorial-panel-header">
        {onBack && (
          <button
            type="button"
            className="tutorial-panel-back"
            onClick={onBack}
        ...
        <h2>How to Play</h2>
        <p>Learn how to master Crackle Date</p>
      </header>
        ...
        <div className="tutorial-panel-stats">
          ...
          <div className="tutorial-panel-stat">
            ...
            <div className="tutorial-panel-stat-content">
              ...
              <div className="tutorial-panel-stat-label">Score points for complexity and speed</div>
            </div>
          </div>
          <div className="tutorial-panel-stat">
            <div className="tutorial-panel-stat-icon">
          ...
          <div className="tutorial-panel-section">
            ...
            <div className="tutorial-panel-cards">
              <div className="tutorial-panel-card">
                ...
                <p>
                  Each day you get four digits from the current date (MMDD). Use each digit exactly
                  once to create mathematical equations.
                </p>
              </div>
              <div className="tutorial-panel-card">
              ...
              <div className="tutorial-panel-card">
                ...
                <p>
                  Your equation must equal a valid number. The more complex your equation, the more
                  points you'll score!
                </p>
              </div>
            </div>
          ...
          <div className="tutorial-panel-section">
            ...
            <div className="tutorial-panel-cards">
              ...
              <div className="tutorial-panel-card">
                ...
                <p>
                  Using multiplication, division, and parentheses increases your score. More complex
          ...
          <div className="tutorial-panel-section">
            ...
            <div className="tutorial-panel-cards">
              ...
              <div className="tutorial-panel-card">
                ...
                <p>
                  Control the order of operations with parentheses to create more complex equations.
                </p>
              </div>
              <div className="tutorial-panel-card">
